...
CXX=g++
#FC=gfortran
cmake -G "Ninja" -DCMAKE_GENERATOR:INTERNAL=Ninja  -DCMAKE_INSTALL_PREFIX=${IRIS_INSTALL_ROOT}${IRIS_TAG} -DCMAKE_C_COMPILER=$CC -DCMAKE_CXX_COMPILER=$CXX -DCMAKE_BUILD_TYPE=RELEASE -DTRACE_DISABLE=ON -DAUTO_PARALLEL=ON -DAUTO_FLUSH=ON  .. $@
