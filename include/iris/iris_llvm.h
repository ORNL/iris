#ifndef IRIS_INCLUDE_IRIS_LLVM_H
#define IRIS_INCLUDE_IRIS_LLVM_H

#include <stdlib.h>

#if 1
#define IRIS_LLVM_KERNEL_BEGIN      for (size_t _z = _off2; _z < _off2 + _ndr2; _z++) \
                                    for (size_t _y = _off1; _y < _off1 + _ndr1; _y++) \
                                    for (size_t _x = _off0; _x < _off0 + _ndr0; _x++) {
#define IRIS_LLVM_KERNEL_END        }
#define IRIS_LLVM_KERNEL_ARGS       size_t _off0, size_t _off1, size_t _off2, \
...
#else
#define IRIS_LLVM_KERNEL_BEGIN      for (size_t _gz = _wgo2; _gz < _wgo2 + _wgs2; _gz++) \
...
#define IRIS_LLVM_KERNEL_END        }
#define IRIS_LLVM_KERNEL_ARGS       size_t _wgo0, size_t _wgo1, size_t _wgo2, \
...
#endif /* IRIS_INCLUDE_IRIS_LLVM_H */
