...
int main(int argc, char** argv) {
  ...
  iris_task_submit(task0, iris_minimum, NULL, false);
  iris_task_submit(task1, iris_minimum, NULL, false);
  iris_task_submit(task2, iris_minimum, NULL, false);
  iris_task_submit(task3, iris_minimum, NULL, false);
