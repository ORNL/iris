...
static int iris_openmp_saxpy_setmem(int idx, void* mem) {
  switch (idx) {
    case 0: saxpy_args.Z = (__global double*__restrict) mem; break;
    case 1: saxpy_args.X = (__global double*__restrict) mem; break;
    case 2: saxpy_args.Y = (__global double*__restrict) mem; break;
    default: return IRIS_ERROR;
  }
  return IRIS_SUCCESS;
}
