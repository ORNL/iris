...
#run CUDA baseline
./task-latency-cuda 1 1 1000    kernellaunch-cuda-${MACHINE}-1.csv
./task-latency-cuda 1 10 1000   kernellaunch-cuda-${MACHINE}-10.csv
./task-latency-cuda 1 100 1000  kernellaunch-cuda-${MACHINE}-100.csv
./task-latency-cuda 1 1000 1000 kernellaunch-cuda-${MACHINE}-1000.csv

#run IRIS single device
IRIS_ARCHS=cuda ./task-latency-iris 1 1 1000    kernellaunch-iris-cuda-${MACHINE}-1.csv
IRIS_ARCHS=cuda ./task-latency-iris 1 10 1000   kernellaunch-iris-cuda-${MACHINE}-10.csv
IRIS_ARCHS=cuda ./task-latency-iris 1 100 1000  kernellaunch-iris-cuda-${MACHINE}-100.csv
IRIS_ARCHS=cuda ./task-latency-iris 1 1000 1000 kernellaunch-iris-cuda-${MACHINE}-1000.csv
...
IRIS_ARCHS=cuda ./task-latency-iris 1 1 1000    kernellaunch-multigpu-iris-cuda-${MACHINE}-1.csv
IRIS_ARCHS=cuda ./task-latency-iris 1 10 1000   kernellaunch-multigpu-iris-cuda-${MACHINE}-10.csv
IRIS_ARCHS=cuda ./task-latency-iris 1 100 1000  kernellaunch-multigpu-iris-cuda-${MACHINE}-100.csv
IRIS_ARCHS=cuda ./task-latency-iris 1 1000 1000 kernellaunch-multigpu-iris-cuda-${MACHINE}-1000.csv
