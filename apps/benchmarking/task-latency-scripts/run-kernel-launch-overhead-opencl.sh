...
#run CUDA baseline
./task-latency-opencl 1 1 1000    kernellaunch-opencl-${HOST}-1.csv
./task-latency-opencl 1 10 1000   kernellaunch-opencl-${HOST}-10.csv
./task-latency-opencl 1 100 1000  kernellaunch-opencl-${HOST}-100.csv
./task-latency-opencl 1 1000 1000 kernellaunch-opencl-${HOST}-1000.csv

#run IRIS single device
IRIS_ARCHS=opencl ./task-latency-iris 1 1 1000    kernellaunch-iris-opencl-${HOST}-1.csv
IRIS_ARCHS=opencl ./task-latency-iris 1 10 1000   kernellaunch-iris-opencl-${HOST}-10.csv
IRIS_ARCHS=opencl ./task-latency-iris 1 100 1000  kernellaunch-iris-opencl-${HOST}-100.csv
IRIS_ARCHS=opencl ./task-latency-iris 1 1000 1000 kernellaunch-iris-opencl-${HOST}-1000.csv
...
IRIS_ARCHS=opencl ./task-latency-iris 1 1 1000    kernellaunch-multigpu-iris-opencl-${HOST}-1.csv
IRIS_ARCHS=opencl ./task-latency-iris 1 10 1000   kernellaunch-multigpu-iris-opencl-${HOST}-10.csv
IRIS_ARCHS=opencl ./task-latency-iris 1 100 1000  kernellaunch-multigpu-iris-opencl-${HOST}-100.csv
IRIS_ARCHS=opencl ./task-latency-iris 1 1000 1000 kernellaunch-multigpu-iris-opencl-${HOST}-1000.csv
