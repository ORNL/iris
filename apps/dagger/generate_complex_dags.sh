...
python ./gantt/gantt.py --dag=./graph.json --timeline=./timeline_log.csv --combined-out=combined.pdf --drop="Initialize-0,Initialize-1" --title-string="Shared 10 dataset with any scheduling policy" --drop="Init"
