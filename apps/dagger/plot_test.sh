...
#combined
python ./gantt/gantt.py --dag=./dagger-payloads/linear10-graph.json --timeline=./dagger-figures/linear-10-random-explorer.csv --combined-out=just-combined.pdf --title-string="Linear 10 dataset with RANDOM scheduling policy" --drop="Init"
