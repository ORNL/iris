...
public:
  ...
  void (*iris_geometric_seq_i64)(int64_t *arr, int64_t start, int64_t increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_i32)(int32_t *arr, int32_t start, int32_t increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_i16)(int16_t *arr, int16_t start, int16_t increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_i8)(int8_t  *arr, int8_t start, int8_t increment,  size_t size, void *stream) ;
  void (*iris_geometric_seq_u64)(uint64_t *arr, uint64_t start, uint64_t increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_u32)(uint32_t *arr, uint32_t start, uint32_t increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_u16)(uint16_t *arr, uint16_t start, uint16_t increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_u8)(uint8_t  *arr, uint8_t start, uint8_t increment,  size_t size, void *stream) ;
  void (*iris_geometric_seq_float)(float *arr, float start, float increment, size_t size, void *stream) ;
  void (*iris_geometric_seq_double)(double *arr, double start, double increment, size_t size, void *stream) ;
