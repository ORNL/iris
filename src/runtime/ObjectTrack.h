        ...
        class ObjectTrack
        {
            public:
                ...
                virtual bool CallBackIfObjectExists(unsigned long uid, ObjectTrackCallBack callbackfn) {
                    ...
                    _printf("Waiting for lock uid:%lu", uid);
                    pthread_mutex_lock(&track_lock_);
                    _printf("Acquired lock uid:%lu", uid);
                    if (allocated_objects_.find(uid) != allocated_objects_.end() &&
                    ...
                    _printf("Released lock uid:%lu", uid);
                ...
                virtual void Clear() {
                    ...
                    _printf("Waiting for lock");
                    pthread_mutex_lock(&track_lock_);
                    _printf("Acquired lock ");
